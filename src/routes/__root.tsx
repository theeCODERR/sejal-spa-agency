...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sejal Relax Spa" },
      { name: "description", content: "A cinematic dark spa experience. Signature massages, rituals, and facials in an intimate candlelit sanctuary." },
      { name: "author", content: "Sejal Relax Spa" },
      { property: "og:title", content: "Sejal Relax Spa" },
      { property: "og:description", content: "A cinematic dark spa experience. Signature massages, rituals, and facials in an intimate candlelit sanctuary." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Sejal Relax Spa" },
      { name: "twitter:description", content: "A cinematic dark spa experience. Signature massages, rituals, and facials in an intimate candlelit sanctuary." },
